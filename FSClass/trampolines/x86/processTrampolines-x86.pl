...
my $outputFileName = "trampoline-x86.c";


#my $blrOpcode = hex "4e800020";

my $asmFileName = "trampoline-x86.asm";
my $intermediateFileName = "trampoline-x86.out";


system qw(nasm -f macho -l), $intermediateFileName, $asmFileName;
...
my %trampolines = (
     getter => { tag => 'Property accessor', code => '', len => 0 }, 
...
print $cFile <<"C";
unsigned int getter_len = $getterLength;
char* getter =
$getterCode
;
C
